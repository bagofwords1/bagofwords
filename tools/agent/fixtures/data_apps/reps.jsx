      ...
      {activeTab === 'representatives' ? (
        <main className="ro-workspace">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (window.matchMedia('(max-width: 900px)').matches) {
                        requestAnimationFrame(() => document.querySelector('.ro-detail-panel')?.scrollIntoView({ block: 'start' }));
                      }
                    }}
          ...
          <aside className="ro-detail-panel">
            <button type="button" className="ro-return" onClick={() => document.querySelector('.ro-rep-row.is-selected')?.scrollIntoView({ block: 'center' })}>Back to representatives</button>
...
.ro-return { display: none; color: var(--bow-accent); font: inherit; border: 1px solid var(--ro-line); border-radius: 6px; padding: 8px 12px; background: transparent; }
@media (max-width: 900px) { .ro-return { display: inline-flex; margin-bottom: 18px; } }
