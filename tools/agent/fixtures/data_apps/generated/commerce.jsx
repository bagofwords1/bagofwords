...
function App() {
  ...
  const marketOption = {
    ...
    xAxis: { type: 'value', axisLabel: { formatter: value => fmt(value, { compact: true, currency: true }) } },
  ...
  return (
    <div className="cw-shell">
      <style>{`
        ...
        .cw-control-grid{display:grid;grid-template-columns:1.1fr 1.3fr 1fr 1fr auto;gap:13px;align-items:end}
