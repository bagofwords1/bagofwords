/** Source metadata only: never infer a relationship from similar column names. */
export type GraphTable = {
  id?: string; name: string; is_active: boolean; connection_id?: string; connection_name?: string;
...
export type TableLink = { id: string; source: string; target: string; columns: { from: string; to: string }[] }
