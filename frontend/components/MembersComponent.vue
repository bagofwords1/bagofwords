<template>
    <div class="mt-4">
        ...
        <div
            ...
            class="flex flex-wrap items-center gap-2 mb-4 px-3 py-2 rounded-lg border border-blue-200 bg-blue-50/60 dark:bg-blue-950"
        >
        ...
        <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                    <thead class="bg-gray-50/60 dark:bg-gray-800/60">
                        <tr>
                            ...
                            <th
                                v-if="useCan('remove_organization_members')"
                                class="sticky right-0 z-20 bg-gray-50 dark:bg-gray-800 border-s border-gray-200 dark:border-gray-700 px-4 py-2 text-end text-xs font-medium text-gray-500 dark:text-gray-400"
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <!-- Data rows -->
                        <template v-else>
                            <tr v-for="member in paginatedMembers" :key="member.id" class="group hover:bg-gray-50/70 dark:hover:bg-gray-800 transition-colors" :class="{ 'bg-blue-50/40 dark:bg-blue-950': isSelected(member.id) }">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    ...
                                    <div v-else class="flex items-center">
                                        <div class="flex-shrink-0 h-7 w-7 rounded-full bg-gray-50 dark:bg-gray-900 text-gray-300 dark:text-gray-600 flex items-center justify-center text-xs font-medium ring-1 ring-inset ring-gray-200 dark:ring-gray-700">
                                ...
                                <td class="px-4 py-2 min-w-[18rem]">
                                    <input
                                        ...
                                        maxlength="500"
                                        placeholder="—"
                                        class="w-full text-sm text-gray-700 dark:text-gray-300 placeholder:text-gray-300 dark:placeholder:text-gray-600 border border-transparent hover:bg-gray-100 dark:hover:bg-gray-700 focus:bg-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-md px-2 py-1 outline-none bg-transparent transition-colors"
                                    />
                                ...
                                <td class="sticky right-0 z-10 border-s border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 group-hover:bg-gray-50 dark:group-hover:bg-gray-800 px-4 py-2 whitespace-nowrap"
                                    v-if="useCan('remove_organization_members')"
                                >
    ...
    <UModal v-model="inviteModalOpen">
        <div class="p-4 relative">
            <button @click="inviteModalOpen = false" class="absolute top-2 end-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 outline-none">
    ...
    <UModal v-model="importModalOpen" :ui="{ width: 'sm:max-w-2xl' }">
        <div class="p-4 relative">
            <button @click="closeImportModal" class="absolute top-2 end-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 outline-none">
                <Icon name="heroicons:x-mark" class="w-5 h-5" />
            </button>
            ...
            <div v-if="!importReport" class="space-y-3">
                <input
                    ...
                    class="block w-full text-sm text-gray-700 dark:text-gray-300 file:mr-3 file:py-1.5 file:px-3 file:rounded file:border-0 file:text-sm file:font-medium file:bg-blue-50 dark:file:bg-blue-950 file:text-blue-700 hover:file:bg-blue-100 dark:hover:file:bg-blue-900/50"
                />
                <button
                    type="button"
                ...
                <div v-if="importError" class="text-sm text-red-600 bg-red-50 dark:bg-red-950 border border-red-200 rounded px-3 py-2">
                    {{ importError }}
                </div>
            ...
            <div v-else class="space-y-3">
                ...
                <div class="max-h-80 overflow-auto border border-gray-200 dark:border-gray-700 rounded">
