...
- **Pick your agents from a blank report** — when a workspace has more than one agent, an empty report now lists them under "Ask a question to get started"; click to select one or several, and the starter questions below update to match the agents you picked
