...
- **Smaller default doc body text** — document body text is now 14px (down from 15px) in both the viewer and editor, for a tighter, document-scale feel closer to Google Docs / Notion; headings are unchanged.
