...
class ExternalUserMapping(BaseSchema):
    ...
    app_user_id = Column(String(36), ForeignKey("users.id"), nullable=False)
    ...
    app_user = relationship("User", back_populates="external_mappings")
    platform = relationship("ExternalPlatform", back_populates="user_mappings")
