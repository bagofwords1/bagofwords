    ...
    def test_connection(self) -> dict:
        ...
        try:
            ...
            if self._user_token_provided:
                ...
                # the first page of the root.
                drive_id = _step("drive_ms", self._resolve_drive_id)
                root_id = _step("root_ms", self._resolve_root_item_id)
                ...
                where = self.folder_path or ("the site library" if self.mode == "sharepoint" else "OneDrive")
                if sample:
