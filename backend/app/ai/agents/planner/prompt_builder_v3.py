...
- **published**: clarify ONLY when truly blocked — a core business term with several materially different meanings ("active users", "churn", "best performer") and no schema/instruction hint; a request whose target entity is genuinely undeterminable; or required data you can't infer. One clarify turn beats building the wrong thing.
