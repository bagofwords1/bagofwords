...
class ReadArtifactInput(BaseModel):
    ...
    offset: Optional[int] = Field(
        ...
        description=(
            ...
            "The returned code slice is VERBATIM — safe to quote in apply_artifact_edit find ops or edit_doc find strings."
        ),
    )
    ...
    grep_pattern: Optional[str] = Field(
        ...
        description=(
            ...
            "safe to quote in apply_artifact_edit find ops or edit_doc find strings. "
