    ...
    def metadata(self) -> ToolMetadata:
        return ToolMetadata(
            ...
            description=(
                ...
                "- NO MARKDOWN. This is an email, not a chat message: the body is delivered "
                "verbatim, so '**bold**', '# headers', '`code`' and '| col |' pipe tables "
                "show up as literal punctuation in the inbox. Use blank lines between "
                "paragraphs, '- ' bullets, and 'Label: value' lines instead of a table — see "
                "the 'body' field for the full rules.\n"
                "- Tabular data goes in an attachment (CSV/XLSX), never inlined as a table.\n"
                "- body_format='html' is for the rare message that genuinely needs bold, "
                "italic, underline, or a real table; keep that HTML simple and inline-styled.\n"
